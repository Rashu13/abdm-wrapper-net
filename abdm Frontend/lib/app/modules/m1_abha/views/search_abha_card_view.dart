          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          GestureDetector(
                            onTap: () => setState(() => _authType = 'ABHA OTP'),
                            child: Text(
                              'ABHA OTP',
                              style: fontMedium.copyWith(
                                  fontSize: 14, color: const Color(0xFF0F172A)),
                ...
                Obx(() {
                  if (controller.txnId.value.isNotEmpty || _selectedTabIndex != 0) {
                ...
                Obx(() {
                  ...
                  if (!hasOtpBeenSent) {
                        ...
                        onPressed: controller.isLoading.value
                            ...
                            : () {
                                ...
                                if (_selectedTabIndex == 0) {
                                  ...
                                  loginTypeParam = _authType == 'Aadhaar OTP' ? 'aadhaar' : 'abha-number';
                                } else if (_selectedTabIndex == 3) {
                                  loginTypeParam = _authType == 'Aadhaar OTP' ? 'aadhaar' : 'abha-address';
                                }

                                controller.inputNumber.value = inputVal;
                                controller.setMode(false);
                                controller.sendOtp(inputVal, loginType: loginTypeParam);
                              },
                    ...
                    if (controller.maskedMobile.value.isNotEmpty) {
                    ...
                    } else if (controller.communicationMobile.value.length >=
                        4) {
                      String last4 = controller.communicationMobile.value
                          .substring(
                              controller.communicationMobile.value.length - 4);
                      bannerText =
                      ...
                      String last4 = controller.inputNumber.value.substring(6);
                      bannerText =
                    ...
                    return Column(
                      ...
                      children: [
                          ...
                          child: Pinput(
                            ...
                            focusedPinTheme: defaultPinTheme.copyWith(
                              decoration: defaultPinTheme.decoration!.copyWith(
                                border: Border.all(
                                    color: const Color(0xFF0F4C81), width: 2),
                              ),
                            ),
                          ),
                        ),
                        ...
                        Obx(() {
                          ...
                          final secFormatted = controller.resendSeconds.value
                              .toString()
                              .padLeft(2, '0');
